...
RSpec.describe NestedCrystallographicStructureInput, type: :input do
  ...
  it 'generates the correct fields' do
    ...
    is_expected.to have_field('dataset_complex_crystallographic_structure_attributes_0_category_description', type: :text, with: 'crystallographic_structure category 1')
    is_expected.to have_field('dataset_complex_crystallographic_structure_attributes_0_category_vocabulary', type: :text, with: 'crystallographic_structure/123456')
