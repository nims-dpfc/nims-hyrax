...
RSpec.describe NestedSpecimenTypeInput, type: :input do
  ...
  it 'generates the correct fields' do
    ...
    is_expected.not_to have_select('dataset[complex_specimen_type_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'Identifier - Persistent')
    ...
    is_expected.not_to have_select('dataset[complex_specimen_type_attributes][0][complex_material_type_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'Identifier - Persistent')
    ...
    is_expected.to have_field('dataset[complex_specimen_type_attributes][0][complex_purchase_record_attributes][0]_complex_identifier_attributes_0_identifier', type: :text, with: 'purchase_record/123456')
    ...
    is_expected.not_to have_select('dataset[complex_specimen_type_attributes][0][complex_shape_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'Identifier - Persistent')
    ...
    is_expected.not_to have_select('dataset[complex_specimen_type_attributes][0][complex_state_of_matter_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'Identifier - Persistent')
    ...
    is_expected.not_to have_select('dataset[complex_specimen_type_attributes][0][complex_structural_feature_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'Identifier - Persistent')
