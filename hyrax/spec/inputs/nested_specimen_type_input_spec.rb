...
RSpec.describe NestedSpecimenTypeInput, type: :input do
  ...
  it 'generates the correct fields' do
    ...
    is_expected.to have_select('dataset[complex_specimen_type_attributes][0][complex_purchase_record_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'Identifier - Persistent')
