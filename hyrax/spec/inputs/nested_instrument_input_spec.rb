...
RSpec.describe NestedInstrumentInput, type: :input do
  ...
  it 'generates the correct fields' do
    ...
    is_expected.to have_select('dataset[instrument_attributes][0]_complex_date_attributes_0_description', selected: 'Published')
    ...
    is_expected.to have_field('dataset[instrument_attributes][0]_complex_identifier_attributes_0_identifier', type: :text, with: '123456')

    is_expected.to have_field('dataset[instrument_attributes][0]_instrument_function_attributes_0_column_number', type: :text, with: '1')
    ...
    is_expected.to have_select('dataset[instrument_attributes][0][complex_person_attributes][0]_complex_identifier_attributes_0_scheme', selected: 'NIMS Person ID')
    is_expected.to have_field('dataset[instrument_attributes][0][complex_person_attributes][0]_complex_identifier_attributes_0_identifier', type: :text, with: '123456789mo')
