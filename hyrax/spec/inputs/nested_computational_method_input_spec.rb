...
RSpec.describe NestedComputationalMethodInput, type: :input do
  ...
  it 'generates the correct fields' do
    is_expected.to have_field('dataset_complex_computational_method_attributes_0_category_vocabulary', type: :text, with: 'http://vocabulary.example.jp/Q234')
    is_expected.to have_field('dataset_complex_computational_method_attributes_0_category_description', type: :text, with: 'Q234')
