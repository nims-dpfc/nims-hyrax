...
RSpec.describe RoleService do
  ...
  describe "find_by_id" do
    it "returns active term matching id" do
      expect(service.find_by_id('translator')).to include({
  ...
  describe "find_by_label" do
    it "returns active term  matching label" do
      expect(service.find_by_label('translator/翻訳者')).to include({
        "label" => "translator/翻訳者",
        "id" => "translator",
        "active" => true
      })
  ...
  describe "find_by_id_or_label" do
    it "returns active term matching id or label" do
      expect(service.find_by_id_or_label('translator')).to include({
        "label" => "translator/翻訳者",
        "id" => "translator",
        "active" => true
      })
      expect(service.find_by_id_or_label('translator/翻訳者')).to include({
        "label" => "translator/翻訳者",
        "id" => "translator",
        "active" => true
      })
