# [nims-hyrax override] add virus checking to job
...
class AttachFilesToWorkJob < Hyrax::ApplicationJob
  ...
  def perform(work, uploaded_files, **work_attributes)
    ...
    uploaded_files.each do |uploaded_file|
      # [nims-override] check all files for viruses
      begin
  ...
  # [nims-override] Add virus detection error class
  ...
  # [nims-override] Send notification to depositors and repo admins
