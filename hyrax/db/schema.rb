...
ActiveRecord::Schema.define(version: 2020_01_08_111832) do
  ...
  create_table "qa_local_authority_entries", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "local_authority_id, lower((label)::text)", name: "index_qa_local_authority_entries_on_lower_label"
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.string "employee_type_code"
    t.string "user_identifier"
    t.index ["email"], name: "index_users_on_email"
    t.index ["employee_type_code"], name: "index_users_on_employee_type_code"
    t.index ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true
    t.index ["user_identifier"], name: "index_users_on_user_identifier", unique: true
